...
//             .filter((row) => row.length === headers.length) // avoid empty rows
//             .map((row) =>
...
//         Report Griege
//       </h2>
//       <div className="grid grid-cols-12 bg-blue-900 text-white text-sm">
...
//       </div>
//       {/* ['Date', 'Chalan No', 'Lot Number', "Party's Name", 'Type', 'Design',
//       'Griege', 'Finishing', 'Color', 'Status', 'Delivered By', 'Comments'] */}
//       {demand.map((item, i) => (
//         <Link
//           key={i}
//           to={`${item["Lot Number"]}`}
//           className={`grid grid-cols-12 text-black text-sm hover:bg-gray-500 hover:text-white ${
...
//           <div className="col-span-2">{item["Than"]}</div>
//           <div className="col-span-1">{item["Griege"]}</div>
//           <div className="col-span-1">{item["Finishing"]}</div>
